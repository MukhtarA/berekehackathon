...
export const noColor = colors.gray9
export const transparent = colors.gray0A

export const primary = colors.white
export const secondary = colors.white70A
export const tertiary = colors.white55A
...
export const brandPrimary = colors.green4
export const brandSecondary = colors.green3
export const brandTertiary = colors.green2
export const brandQuaternary = colors.green15
...
export const successPrimary = colors.green4
export const successSecondary = colors.green3
export const successTertiary = colors.green2
export const successQuaternary = colors.green15
...
export const infoPrimary = colors.violet4
export const infoSecondary = colors.violet3
export const infoTertiary = colors.violet2
export const infoQuaternary = colors.violet15
...
export const warningPrimary = colors.orange4
export const warningSecondary = colors.orange3
export const warningTertiary = colors.orange2
export const warningQuaternary = colors.orange15
...
export const additional100 = colors.white
export const additional60 = colors.white60A
export const additional40 = colors.white40A
export const additional24 = colors.white24A
export const additional16 = colors.white16A
export const additional8 = colors.white8A
export const additional4 = colors.white4A

export const focusColor = primary

export const backgroundZero = '#121212'
export const backgroundOne = '#1E1E1E'
export const backgroundOneNeutral = '#1E1E1E'
export const backgroundOneSuccess = '#071F0C'
export const backgroundOneInfo = '#200F2B'
export const backgroundOneWarning = '#291408'
...
/* Shadow */
export const firstShadow = colors.hex2rgba(colors.graphite9, 24)
export const secondShadow = colors.hex2rgba(colors.graphite9, 60)
...
/* Elevation One */
export const elevationOneBody = colors.graphite5
...
export const checkboxOnToggleDisabled = '#BCE2C3'
...
export const dropdownItemHover = additional16
export const dropdownItemClick = additional24

export const dropdownItemSelectedNormal = brandTransparent24
export const dropdownItemSelectedHover = brandTransparent24
export const dropdownItemSelectedClick = brandTransparent40
...
export const alertSuccessBody = colors.green8
export const alertSuccessBorder = colors.green7
export const alertSuccessIcon = successPrimary
export const alertSuccessActions = successSecondary

export const alertDraftBody = colors.gray8
export const alertDraftBorder = colors.gray7
export const alertDraftIcon = primary
export const alertDraftActions = primary

export const alertWarningBody = colors.orange8
export const alertWarningBorder = colors.orange7
export const alertWarningIcon = warningPrimary
export const alertWarningActions = warningSecondary

export const alertInfoBody = colors.violet8
export const alertInfoBorder = colors.violet7
...
export const bannerNavigationButtonNormal = colors.gray7
...
export const iconProductGoals = colors.teal4
export const iconProductCredit = colors.blue4
export const iconProductDeposit = colors.aqua4
export const iconProductCard = colors.green4
